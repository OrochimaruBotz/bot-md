...
module.exports = {
    async handler(chatUpdate) {
        ...
        global.packname = 'WhangsappBotz'
        global.author = 'by humanz'
        //global.author = 'Humanz'
        global.wm2 = 'Whangsapp Bot' + ' '' By Humanz'
        global.wm = namabot + ' ву Humanz'
        global.colong1 = 'Ciss 📸'
        global.colong2 = 'ʙy 𝚃𝚑𝚎.𝚂𝚊𝚍.𝙱𝚘𝚢𝟶𝟷'
        global.kontak2 = [
        ['6288804947282', 'Humanz', 'ᴅᴇᴠᴇʟᴏᴩᴇʀ ʙᴏᴛ', 'humnzofficial@gmail.com', true],
        ]
